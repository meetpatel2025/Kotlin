package com.training.libraryofalltopics.currencyConvertor
...
class CurrencyConvertorMainActivity : AppCompatActivity() {
//    lateinit var title: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.currency_convertor_activity_main)
