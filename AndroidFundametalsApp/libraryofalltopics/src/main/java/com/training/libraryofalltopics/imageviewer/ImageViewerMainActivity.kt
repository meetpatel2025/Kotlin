package com.training.libraryofalltopics.imageviewer
...
class ImageViewerMainActivity : AppCompatActivity() {


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.image_viewer_activity_main)
        ...
        dropDown.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                Toast.makeText(this@ImageViewerMainActivity, "${nameTxt.text.toString()} is selected $selected",
