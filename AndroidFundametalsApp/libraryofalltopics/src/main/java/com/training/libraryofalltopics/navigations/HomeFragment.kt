...
import com.training.libraryofalltopics.databinding.NavFragmentHomeBinding

class HomeFragment : Fragment() {

    private lateinit var binding: NavFragmentHomeBinding
